...
ecco_nc_file = f"OCEAN_VELOCITY_mon_mean_2017-12_ECCO_V4r4_latlon_0p50deg.nc"
...
# out = cv2.VideoWriter('ecco_2017_12.avi',cv2.VideoWriter_fourcc(*'DIVX'), 10, (w,h))
...
for i, (e_arr,n_arr) in enumerate(zip(evel[:][0],nvel[:][0])):
    ...
    filename = f"ecco_2017_12_{str(i).zfill(3)}.png"
    img.save(filename)
    break
